...
REPO_URL = 'https://github.com/nicvw/superlists.git'
...
def _update_settings(source_folder, site_name):
    ...
    secret_key_file = join(source_folder, 'superlists/secret_key.py')
...
def _update_virtualenv(source_folder):
    virtualenv_folder = abspath(join(source_folder, '../virtualenv'))
    pip = join(virtualenv_folder, 'bin/pip')
    if not exists(pip):
